            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?= base_url('Dashboard')?>">Home</a> / <a href="<?= base_url('pembelian/Transaksi')?>">Pembelian</a> /	Detail
                    </li>
                </ol>
            </nav>
        </div>
                    ...
                    <div class="row justify-content-between">
							...
							<div class="row gx-8">
								<div class="col-12 col-md-6">
									<div class="mb-24">
										...
										<input type="text" class="form-control" name="NoPesanan" id="NoPesanan" value="<?= $master[0]->no_pesanan ?>" disabled>
										<input type="hidden" class="form-control" name="NoPesanan" id="St" value="Edit" disabled>
								...
								<div class="mb-24">
									...
									<select class="form-select" id="Supplier" name="nama_supplier" disabled>
										<option selected hidden>--Pilih--</option>
										<option value="Supplier" <?= $master[0]->nama_supplier == 'Supplier' ? 'Selected' : ''?>>Supplier</option>
									</select>
								</div>
								</div>
								...
								<div class="col-12 col-md-6">
									<div class="mb-24">
										...
										<input type="date" class="form-control" name="tanggal_pesanan" id="TanggalPesanan" value="<?= date("Y-m-d", strtotime($master[0]->tanggal_pesanan))?>" disabled>
									</div>
								</div>
								<div class="col-12 col-md-12">
									<div class="mb-24">
										...
										<textarea type="text" class="form-control" name="keterangan" id="Keterangan" value="<?= $master[0]->keterangan?>" disabled><?= $master[0]->keterangan?></textarea>
									</div>
								</div>
						...
						<table class="table table-hover table-striped">
								...
								<tfoot>
									<tr>
										<td colspan="8">
											<!-- <button id="clear-cart" class="btn btn-warning" disabled>clear</button> -->
										</td>
									</tr>
								</tfoot>
								<?php } ?>	
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row justify-content-between">
                        ...
                        <div class="col hp-flex-none w-auto">
                            <a href="<?= base_url('pembelian/Transaksi/edit/'.$this->uri->segment(4))?>" class="btn btn-warning w-100 mb-12" >
                                <i class="ri-user-add-line remix-icon"></i>
                                <span>Edit</span>
                            </a>
                        </div>
