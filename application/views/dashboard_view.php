                                        ...
                                        <div class="card-body p-16">
                                            <div class="row">
                                                <div class="col-12 text-center">
                                                    <div class="bg-primary-4 hp-bg-color-dark-90 rounded d-flex align-items-center justify-content-center px-18 mb-18">
                                                        <div id="statistics-order-vertical"></div>
                                                    </div>

                                                    <h3 class="mb-0">13,346</h3>
                                                    <p class="hp-p1-body mb-0 text-black-80 hp-text-color-dark-50">New Order</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-6 col-md-3">
                                    <div class="card hp-card-2">
                                        <div class="card-body p-16">
                                            <div class="row">
                                                <div class="col-12 text-center">
                                                    <div class="bg-warning-4 hp-bg-color-dark-90 rounded d-flex align-items-center justify-content-center px-18 mb-18">
                                                        <div id="statistics-users-vertical"></div>
                                                    </div>

                                                    <h3 class="mb-0">17,346</h3>
                                                    <p class="hp-p1-body mb-0 text-black-80 hp-text-color-dark-50">Active Users</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-6 col-md-3">
                                    <div class="card hp-card-2">
                                        <div class="card-body p-16">
                                            <div class="row">
                                                <div class="col-12 text-center">
                                                    <div class="bg-success-4 hp-bg-color-dark-90 rounded d-flex align-items-center justify-content-center px-18 mb-18">
                                                        <div id="statistics-subscribe-vertical"></div>
                                                    </div>

                                                    <h3 class="mb-0">1,346</h3>
                                                    <p class="hp-p1-body mb-0 text-black-80 hp-text-color-dark-50">Active Subscribe</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-6 col-md-3">
                                    <div class="card hp-card-2">
                                        <div class="card-body p-16">
                                            <div class="row">
                                                <div class="col-12 text-center">
                                                    <div class="bg-secondary-4 hp-bg-color-dark-90 rounded d-flex align-items-center justify-content-center px-18 mb-18">
                                                        <div id="statistics-ticket-vertical"></div>
                                                    </div>

                                                    <h3 class="mb-0">2,345</h3>
                                                    <p class="hp-p1-body mb-0 text-black-80 hp-text-color-dark-50">Ticket Closed</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-32 justify-content-between">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap">
                                                ...
                                                <p class="hp-p1-body text-black-60 hp-text-color-dark-50 ms-8 mb-0">Highest income this month</p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row g-8 align-items-center justify-content-center">
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="avatar-item d-flex align-items-center justify-content-center bg-primary-3 rounded-circle" style="width: 36px; height: 36px;">
                                                        <img src="<?= base_url()?>assets/app-assets/img/dasboard/analytics-marketing-team-1.svg">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="avatar-item d-flex align-items-center justify-content-center bg-info-3 rounded-circle" style="width: 36px; height: 36px;">
                                                        <img src="<?= base_url()?>assets/app-assets/img/dasboard/analytics-marketing-team-2.svg">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="avatar-item d-flex align-items-center justify-content-center bg-black-60 rounded-circle" style="width: 36px; height: 36px;">
                                                        <img src="<?= base_url()?>assets/app-assets/img/dasboard/analytics-marketing-team-3.svg">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="avatar-item d-flex align-items-center justify-content-center bg-danger-3 rounded-circle" style="width: 36px; height: 36px;">
                                                        <img src="<?= base_url()?>assets/app-assets/img/dasboard/analytics-marketing-team-4.svg">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="avatar-item d-flex align-items-center justify-content-center bg-secondary-3 rounded-circle" style="width: 36px; height: 36px;">
                                                        <img src="<?= base_url()?>assets/app-assets/img/dasboard/analytics-marketing-team-5.svg">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="avatar-item d-flex align-items-center justify-content-center bg-warning-3 rounded-circle" style="width: 36px; height: 36px;">
                                                        <img src="<?= base_url()?>assets/app-assets/img/dasboard/analytics-marketing-team-6.svg">
                                                    </div>
                                                </div>
                    ...
                    <div class="row g-32">
                            ...
                            <div class="card hp-card-6">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div id="expenses-donut-card" class="hp-donut-chart"></div>
                                        </div>

                                        <div class="col-12 mt-24">
                                            <h5 class="mb-24">By Category</h5>

                                            <a href="javascript:;" class="d-block hp-transition my-4 py-12 px-6 rounded hp-hover-bg-color-primary-4 hp-hover-bg-color-dark-primary">
                                                <div class="row align-items-center justify-content-between">
                                                    <div class="col" style="flex: 0.9 1 0%;">
                                                        <div class="row align-items-center">
                                                            <div class="col hp-flex-none w-auto">
                                                ...
                                                <div class="row align-items-center justify-content-between">
                                                    <div class="col" style="flex: 0.9 1 0%;">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col flex-grow-1 pe-0">
                                                                <h5 class="mb-0">Company Expenses</h5>
                                                                <p class="hp-p1-body text-black-60 mb-0">Promotion &amp; Commercial</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col" style="flex: 0.9 1 0%;">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col flex-grow-1 pe-0">
                                                                ...
                                                                <p class="hp-p1-body text-black-60 mb-0">Checkout last years expenses</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col" style="flex: 0.9 1 0%;">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col flex-grow-1 pe-0">
                                                                ...
                                                                <p class="hp-p1-body text-black-60 mb-0">Checkout hotel expenses</p>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-12">
                            <div class="card border-none hp-card-2 px-12 py-16 hp-upgradePlanCardOne">
                                <div class="position-absolute top-0 start-0 w-100 h-100 hp-dark-none" style="background-image: url(<?= base_url()?>assets/app-assets/img/dasboard/analytics-download-bg.png); background-size: cover; background-position: right center; z-index: -1;"></div>
                                <div class="position-absolute top-0 start-0 w-100 h-100 hp-dark-block" style="background-image: url(<?= base_url()?>assets/app-assets/img/dasboard/analytics-download-bg-dark.png); background-size: cover; background-position: right center; z-index: -1;"></div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col hp-flex-none w-auto position-absolute top-0 end-0 h-100 pe-0">
                                            <img src="<?= base_url()?>assets/app-assets/img/dasboard/analytics-download-vector.svg" class="h-100 hp-dir-scale-x-n1" alt="Check the Best Prices of New Models &amp; Boost Your Business">
                                        </div>
                                    </div>
                                </div>
                            </div>
