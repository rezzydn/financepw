                                ...
                                <div class="col-12 col-lg-12">
                                    <ul class="nav nav-pills mb-12" id="pills-tab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" href="<?= base_url('gudang/BarangMasuk/index')?>">Pesanan Pembelian</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                                                ...
                                                                <tbody>
																	<?php foreach ($data as $key => $value) { ?>
																		<tr>
																			...
																			<td><?= $value->lokasi?></td>
																			<th scope="row">
																			<?php if ($data_diterima): ?>
																			<?php $found = false; ?>
																			<?php foreach ($data_diterima as $elements): ?>
																				<?php foreach ($elements as $element): ?>
																					<?php if ($element['no_pesanan'] === $value->no_pesanan): ?>
																						<?php $found = true; ?>
																						<?php break 2; ?> <!-- Exit both foreach loops -->
																					<?php endif; ?>
																				<?php endforeach; ?>
																			<?php endforeach; ?>
																			<?php if ($found): ?>
																				<?php foreach ($data_diterima[$value->no_pesanan] as $item): ?>
																					<?= $item['no_terima'] ?>
																				<?php endforeach; ?>
																			<?php else: ?>
																				-
																			...
																			<td>
																				<span <?= $value->StatusInt1 < $value->qty ? 'class="text-warning"' : 'class="text-success"' ;?>>
																					<?= $value->StatusInt1?>/<?= $value->qty?>
																				</span>
																			</td>
