                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-12">
									...
									<li class="nav-item" role="presentation">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" href="<?= base_url('gudang/BarangMasuk/penerimaanBarang')?>" >Penerimaan Barang</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
											<a class="nav-link" href="<?= base_url('gudang/BarangMasuk/barangReturn')?>" >Barang Return</a>
                                        </li>
                                    </ul>
                                                                ...
                                                                <tbody>
																	<?php foreach ($data as $key => $value) { ?>
																		<tr>
																			...
																			<td><?= $value->no_penempatan?></td>
																			<td><?= $value->user?></td>
																			<td>
																				<span <?= $value->qty_progres < $value->qty_total ? 'class="text-warning"' : 'class="text-success"' ;?>>
																					<?= $value->qty_progres?>/<?= $value->qty_total?>
																				</span>
																			</td>
																			<td><?= $value->keterangan?></td>
																			<td>
																				<a href="<?= base_url('gudang/BarangMasuk/updatePenerimaanBarang/'.$value->no_terima)?>" <?= $value->qty_total == $value->qty_progres ? 'class="btn disabled"' : 'class="btn btn-success"' ?>><?= $value->qty_total == $value->qty_progres ? '<i class="hp-text-color-dark-0 ri-2x ri-lock-line"></i>' : 'Terima' ?></a>
																			</td>
																		</tr>
																	<?php }?>
                                                                </tbody>
