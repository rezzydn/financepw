                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-12">
                                    <ul class="nav nav-pills mb-12" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" href="<?= base_url('persediaan/MonitorStok/menipis')?>" >Stok Menipis</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" href="<?= base_url('persediaan/MonitorStok/palinglaku')?>" >Paling Laku</button>
                                        </li>
                                    </ul>
