						...
						<table class="table table-hover table-striped " id="example" >
                            ...
                            <tbody>
								...
								<tr>
                                    ...
                                    <td>
										<a href="<?= base_url('finance/Akun/edit/'.$value->idPerkiraanAkun)?>" class="btn btn-secondary btn-sm m-2">Edit</a>
										<a href="<?= base_url('finance/Akun/delete/'.$value->idPerkiraanAkun)?>" class="btn btn-danger btn-sm m-2" onclick="return confirm('are you sure?')">Delete</a>
									</td>
                                </tr>
								<?php }?>
                            </tbody>
...
<div class="modal fade" id="add_perkiraan_akun" tabindex="-1" aria-labelledby="addNewUserLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
			...
			<form action="<?= base_url('finance/Akun/store')?>" method="POST">
