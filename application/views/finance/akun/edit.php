		...
		<div class="card-body">
			<div class="row justify-content-between">
				...
				<div class="col-12 mt-16">
					<form action="<?= base_url('master/PerkiraanAkun/update')?>" method="POST">
						<div class="mb-24">
						...
						<div class="text-end">
							<a href="<?= base_url('finance/Akun')?>" class="btn btn-text text-black-100 hp-hover-bg-black-10 hp-hover-bg-dark-80 hp-hover-text-color-dark-0">Batal</a>
