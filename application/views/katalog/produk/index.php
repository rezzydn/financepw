<div class="hp-main-layout-content">
            ...
            <div class="row g-32">
                ...
                <div class="col hp-ecommerce-app-sidebar" style="flex: 0 0 270px;">
                    <div class="row mx-0 rounded overflow-hidden border border-black-40 hp-border-color-dark-80 bg-black-0 hp-bg-color-dark-100 px-24 py-16">
                        ...
                        <div class="col-12 px-0">
                            <a class="collapsed" data-bs-toggle="collapse" href="#sidebar-menu-1" role="button" aria-expanded="false" aria-controls="sidebar-menu-1">
                                <div class="d-flex align-items-center justify-content-between">
                                    <h5 class="mb-0 text-black-80 hp-text-color-dark-30">Kategori</h5>
                            ...
                            <div class="collapse" id="sidebar-menu-1">
                                <div class="row mt-16">
                                    <div class="col-12">
                                        <a href="javascript:;" class="hp-badge-text d-block text-black-80 hp-text-color-dark-30">Satuan</a>
                                    </div>
                                    <div class="col-12 mt-10">
                                        <a href="javascript:;" class="hp-badge-text d-block text-black-80 hp-text-color-dark-30">Bundling</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 px-0">
                            <a class="collapsed" data-bs-toggle="collapse" href="#sidebar-menu-2" role="button" aria-expanded="false" aria-controls="sidebar-menu-1">
                                <div class="d-flex align-items-center justify-content-between">
                                    <h5 class="mb-0 text-black-80 hp-text-color-dark-30">Jenis</h5>
                                    <i class="ri-arrow-right-s-line hp-collapse-arrow hp-text-color-black-60 lh-1" style="font-size: 24px;"></i>
                                </div>
                            </a>
                            ...
                            <div class="collapse" id="sidebar-menu-2">
                                <div class="row mt-16">
                                    <div class="col-12">
                                        <a href="javascript:;" class="hp-badge-text d-block text-black-80 hp-text-color-dark-30">Moisturizer</a>
                                    </div>
                                    <div class="col-12 mt-10">
                                        <a href="javascript:;" class="hp-badge-text d-block text-black-80 hp-text-color-dark-30">Toner</a>
                                    </div>
                                    <div class="col-12 mt-10">
                                        <a href="javascript:;" class="hp-badge-text d-block text-black-80 hp-text-color-dark-30">Clay Mask</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row hp-ecommerce-app-header mb-32 g-16">
                        ...
                        <div class="col hp-flex-none w-auto hp-ecommerce-app-header-select">
                            <a class="btn btn-primary w-100" href="">
                                <i class="ri-add-box-line remix-icon"></i>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="row mx-0 align-items-start justify-content-between">
                                                        ...
                                                        <span class="badge bg-primary-4 hp-bg-dark-primary text-primary border-none w-auto py-8 px-16 fw-medium"><?= $row->category?></span>
                                                ...
                                                <div class="col-12">
                                                    <div class="text-center my-24">
                                                        <a href="app-ecommerce-product-detail.html" class="d-block">
                                                            <img src="<?= base_url('assets/images/products-pw/'.$row->pic_1); ?>" alt="" height="125">
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="row justify-content-between">
                                                        ...
                                                        <div class="col w-auto">
                                                            <div class="d-flex align-items-center justify-content-end">
                                                                ...
                                                                <p class="w-auto px-0 mb-0 text-primary fw-medium"><?= $this->M_Crud->format_harga($row->price)?></p>
                                                    ...
                                                    <div class="col-12 mb-16 mt-16">
                                                        <p class="mb-4 text-black-100 hp-text-color-dark-0 hp-p1-body fw-medium"><?= $row->product_name?></p>
                                                        <p class="mb-0 hp-caption fw-normal text-black-80 hp-text-color-dark-30">By Prettywell</p>
                                                    </div>

                                                    <div class="row g-8">
                                                        <div class="col-12">
                                                            <a href="#">
                                                                <button type="button" class="btn btn-primary px-12 w-100">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-32">
                                                <div class="col-12 col-md-5 mb-24 mb-md-0">
                                                    ...
                                                    <div class="col-12 text-center">
                                                        <a href="app-ecommerce-product-detail.html">
                                                            <img src="<?= base_url('assets/images/products-pw/'.$row->pic_1); ?>" alt="Smart Watches 3" height="155">
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-7">
                                                    ...
                                                    <div class="my-8">
                                                        <h4 class="mb-4"><?= $row->product_name?></h4>
                                                        <p class="hp-caption mb-0 text-black-60">By <span class="text-black-80 hp-text-color-dark-30">PrettyWell</span></p>
                                                    </div>
    ...
    <div class="hp-ecommerce-app-sidebar-mobile offcanvas offcanvas-start" tabindex="-1" id="ecommerceMobilSidebar" aria-labelledby="ecommerceMobilSidebarLabel">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="ecommerceMobilSidebarLabel">Filters</h5>
        ...
        <div class="offcanvas-body">
            <div class="hp-ecommerce-app-sidebar">
                <div class="row mx-0">
                    <div class="col-12 px-0">
